...
public class Awasf extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_awasf);
    ...
    private void resetSteps()
    {
        ...
        step.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(Awasf.this,"Long Press to reset",Toast.LENGTH_SHORT);
            }
        });
        ...
        stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Awasf.this, "Total Steps: " + totalStepsBeforeStop, Toast.LENGTH_SHORT).show();
                Toast.makeText(Awasf.this, "Total Calorie Burn: " + calBurn, Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(Awasf.this, MainActivity2.class);
