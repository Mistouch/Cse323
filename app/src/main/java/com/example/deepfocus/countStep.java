...
public class countStep extends AppCompatActivity {
    ...
    private void resetSteps()
    {
        ...
        step.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(countStep.this,"Long Press to reset",Toast.LENGTH_SHORT);
            }
        });
        ...
        stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(countStep.this, "Total Steps: " + totalStepsBeforeStop, Toast.LENGTH_SHORT).show();
                //  Toast.makeText(MainActivity.this, "Total Calorie Burn: " + calBurn, Toast.LENGTH_SHORT).show();

                // Start  activity
                Intent intent = new Intent(countStep.this, MainActivity.class);
